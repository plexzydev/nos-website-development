      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_2fr]">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 transition-all hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
            <img src="/flecha-azul.png" alt="" className="absolute -right-4 -top-4 w-36 h-36 object-contain opacity-40 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12" />
            <div className="relative">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 transition-all hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
            <img src="/flecha-amarillo.png" alt="" className="absolute -right-4 -top-4 w-36 h-36 object-contain opacity-40 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12" />
            <div className="relative">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 transition-all hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
            <img src="/flecha-verde.png" alt="" className="absolute -right-4 -top-4 w-36 h-36 object-contain opacity-40 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12" />
            <div className="relative">
