      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_2fr]">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 transition-all hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
            <div className="absolute right-0 top-0 size-24 -translate-y-4 translate-x-4 rounded-full bg-blue-500/5 flex items-center justify-center">
              <img src="/flecha-azul.png" alt="" className="size-16 object-contain opacity-40 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12" />
            </div>
            <div className="relative">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 transition-all hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
            <div className="absolute right-0 top-0 size-24 -translate-y-4 translate-x-4 rounded-full bg-primary/5 flex items-center justify-center">
              <img src="/flecha-amarillo.png" alt="" className="size-16 object-contain opacity-40 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12" />
            </div>
            <div className="relative">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 transition-all hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
            <div className="absolute right-0 top-0 size-24 -translate-y-4 translate-x-4 rounded-full bg-emerald-500/5 flex items-center justify-center">
              <img src="/flecha-verde.png" alt="" className="size-16 object-contain opacity-40 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12" />
            </div>
            <div className="relative">
